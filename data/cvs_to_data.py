...
# convert_file(f'{CATEGORIES}.csv', f'{CATEGORIES}.json', 'ads.category')
# convert_file(f'{LOC}.csv', f'{LOC}.json', 'users.user')
convert_file(f'{USER}.csv', f'{USER}.json', 'users.location')
